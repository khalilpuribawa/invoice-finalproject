    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex space-x-8">
                ...
                <span class="text-white font-medium">Edit Invoice</span>
            </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-300 md:ml-2">Edit Invoice</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-white flex items-center">
                    ...
                    Edit Invoice: <span class="text-blue-400 ml-2">{{ $invoice->invoice_number }}</span>
                </h1>
                <a href="{{ route('user.invoices.show', $invoice) }}" class="inline-flex items-center px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 text-sm font-medium hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-blue-500 transition-colors duration-200">
            ...
            <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg border border-gray-700">
                <div class="p-6">
                    <form method="POST" action="{{ route('user.invoices.update', $invoice) }}" class="space-y-6">
                        @method('PUT')
            ...
            <!-- Tips Section -->
            <div class="mt-8 bg-blue-900/30 rounded-lg p-4 border border-blue-800/50 text-gray-700 dark:text-gray-100">
                <h3 class="text-lg font-medium text-blue-300 flex items-center mb-2">
                ...
                <ul class="list-disc list-inside text-sm text-gray-300 space-y-1">
                    <li>Make sure all client information is accurate and up-to-date</li>
                    <li>Double-check the invoice amount before saving changes</li>
                    <li>Consider adding a detailed description for better record-keeping</li>
                    <li>Update the due date if payment terms have changed</li>
                </ul>
            </div>
        </div>
    </div>
